...
function dhtmlXFileUploader(p, swfPath, swfUrl, mode, swfLogs, slXap, slUrl, slLogs) {
	...
	this._onUploadSuccess = function(id, serverName, r, extra) {
		...
		if (typeof(r) != "undefined" && this.engine == "flash") {
			window.$form_temp = null;
			try {eval("window.$form_temp="+r.data);} catch(e){};
			var t = window.$form_temp;
			window.$form_temp = null;
...
dhtmlXFileUploader.prototype.html5.prototype = {
	...
	_addFileInput: function() {
		...
		this.f.onchange = function() {
			...
			if (_isOpera) that._addFileInput(); else this.value = "";
		}
	},
	...
	_doUploadFile: function(id) {
		...
		if (!this._loader) {
			...
			this._loader.onload = function(e) {
				window.$form_temp = null;
				try {eval("window.$form_temp="+this.responseText);} catch(e){};
				var r = window.$form_temp;
				window.$form_temp = null;
				if (r != null && typeof(r.state) != "undefined" && r.state == true) {
...
dhtmlXFileUploader.prototype.html4.prototype = {
	...
	_onLoad: function() {
		if (this._uploading) {
			window.$form_temp = null;
			try {eval("window.$form_temp="+this.fr.contentWindow.document.body.innerHTML);} catch(e){};
			var r = window.$form_temp;
			window.$form_temp = null;
