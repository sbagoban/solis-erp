...
try {
    ...
    {
        throw new Exception("NO HOTEL ROOM PHOTO ABSOLUTE PATH DEFINED!");
    }
    ...
    $random_str = utils_generate_unique_token(8, $con, "tblhotel_room_images", "image_name");
    $random_str .= ".$imageFileType";
    

    //update the path name in the database finally
    $sql = "INSERT INTO tblhotel_room_images 
                (roomfk,image_name,image_description,isdefault) 
                VALUES (:roomfk,:image_name,:image_description,:isdefault)";
