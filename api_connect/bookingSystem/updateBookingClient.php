...
// error was suppressed with the @-operator
    ...
    if ($row_count_client > 0) {
        while ($row_client = $stmt->fetch(PDO::FETCH_ASSOC))
        {
            ...
            $sqlBookingClient ="UPDATE booking_client SET
                            id_client= :id_client,
                            ...
                            yearMonth= :yearMonth,
                            remarks= :remarks
                        WHERE id_booking_client=:id_booking_client";
    ...
    {
        $client_result= array("OUTCOME" => "FAIL", "id_booking"=>$id_booking, "id_client"=>$id_client,  "id_booking_client"=>$id_booking_client);
            echo json_encode($client_result);
    }
} catch (Exception $ex) {
