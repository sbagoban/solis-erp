...
// error was suppressed with the @-operator
    ...
    $basis_options = "<option value='%'>%</option><option value='SINGLE'>SNGL</option><option value='DOUBLE'>DBL</option><option value='TRIPLE'>TRPL</option><option value='FLAT'>FLAT</option>";
    ...
    for ($i = 0; $i < count($arr_main_childages); $i++) {
        ...
        print '<column width="70" id="child_basis_' . $agefrom . '_' . $ageto . '" type="combo" '
        ...
        for ($j = 0; $j < count($arr_currency_buy); $j++) {
            ...
            print '<column width="45" id="value_' . $buycurrencyid . '_' . $agefrom . '_' . $ageto . '" type="edn" '
        ...
        for ($j = 0; $j < count($arr_currency_sell); $j++) {
            ...
            print '<column width="45" id="value_' . $sellcurrencyid . '_' . $agefrom . '_' . $ageto . '" type="edn" '
                    . 'align="center" sort="na">#cspan</column>  ';
        }
    }
